...
public class GeneralSecBend extends JFrame implements ActionListener {
	protected EWbendingFrame bF;	
	protected String title;
	protected JTextField secname,area,nT,I,y;
	
	public GeneralSecBend(String title, EWbendingFrame bF){
		super(title);
		this.bF = bF;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Submit")){
			...
			bF.secCombo.addItem(N);
			bF.secCombo.setSelectedItem(N);
