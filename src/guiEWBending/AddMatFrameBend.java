...
public class AddMatFrameBend extends JFrame implements ActionListener {
		...
		public AddMatFrameBend(String name, EWbendingFrame bF){
			super(name);
			this.bF = bF;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Add Material")){
			...
			bF.matCombo.addItem(name);
			bF.matCombo.setSelectedItem(name);
