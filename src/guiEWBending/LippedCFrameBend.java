...
public class LippedCFrameBend extends JFrame implements ActionListener{
	...
	public LippedCFrameBend(String name,EWbendingFrame bF){
		super(name);		
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Submit")){
			...
			bF.secCombo.addItem(name);
			bF.secCombo.setSelectedItem(name);
