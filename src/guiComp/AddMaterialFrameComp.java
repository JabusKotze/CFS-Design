...
public class AddMaterialFrameComp extends JFrame implements ActionListener {
		...
		public AddMaterialFrameComp(String name, DSMCOMPRESSION dsmc){
			super(name);
			this.dsmc = dsmc;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Add Material")){
			...
			dsmc.matCombo.addItem(name);
			dsmc.matCombo.setSelectedItem(name);
