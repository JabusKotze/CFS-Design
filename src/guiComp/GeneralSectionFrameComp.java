...
public class GeneralSectionFrameComp extends JFrame implements ActionListener {
	protected DSMCOMPRESSION dsmc;	
	protected String title;
	protected JTextField secname,area,nT,I,y;
	
	public GeneralSectionFrameComp(String title, DSMCOMPRESSION dsmc){
		super(title);
		this.dsmc = dsmc;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Submit")){
			...
			dsmc.secCombo.addItem(N);
			dsmc.secCombo.setSelectedItem(N);
