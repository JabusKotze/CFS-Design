...
public class LippedChannelFrameTension extends JFrame implements ActionListener{
	...
	public LippedChannelFrameTension(String name,TensionFrame tF){
		super(name);		
