...
public class AddMaterialFrame extends JFrame implements ActionListener {
		...
		public AddMaterialFrame(String name,DSMBENDING dsmb){
			super(name);
			this.dsmb = dsmb;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Add Material")){
			...
			dsmb.matCombo.addItem(name);
			dsmb.matCombo.setSelectedItem(name);
