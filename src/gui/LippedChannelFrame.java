...
public class LippedChannelFrame extends JFrame implements ActionListener{
	...
	public LippedChannelFrame(String name,  DSMBENDING dsmb){
		super(name);		
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Submit")){
			...
			dsmb.secCombo.addItem(name);
			dsmb.secCombo.setSelectedItem(name);
