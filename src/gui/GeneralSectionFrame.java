...
public class GeneralSectionFrame extends JFrame implements ActionListener {
	protected DSMBENDING dsmb;	
	protected String title;
	protected JTextField secname,area,nT,I,y;
	
	public GeneralSectionFrame(String title,DSMBENDING dsmb){
		super(title);
		this.dsmb = dsmb;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Submit")){
			...
			dsmb.secCombo.addItem(N);
			dsmb.secCombo.setSelectedItem(N);
