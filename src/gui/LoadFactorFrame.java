...
public class LoadFactorFrame extends JFrame{
	...
	public LoadFactorFrame(String title,DSMBENDING dsmb){
		super(title);
		this.dsmb = dsmb;
		...
		submit.addActionListener(new LoadFactorListener(this));
	...
	public double getFy(){		
		...
		String mname = dsmb.matCombo.getSelectedItem().toString();
	...
	public double getMaxLength(){
		String sname = dsmb.secCombo.getSelectedItem().toString();
	...
	public double getThickness(){		
		...
		if(digit2.equals("CL")){
			thickness = sd.getLCSection(dsmb.secCombo.getSelectedItem().toString()).getBaseThickness();			
		}else if(digit2.equals("ZL")){
	...
	public double getRadius(){
		...
		if(digit2.equals("CL")){
			radius = sd.getLCSection(dsmb.secCombo.getSelectedItem().toString()).getangleRadius();			
		}else if(digit2.equals("ZL")){
