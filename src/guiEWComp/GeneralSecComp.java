...
public class GeneralSecComp extends JFrame implements ActionListener {
	protected EWCompFrame cF;	
	protected String title;
	protected JTextField secname,area,nT,I,y;
	
	public GeneralSecComp(String title, EWCompFrame cF){
		super(title);
		this.cF = cF;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Submit")){
			...
			cF.secCombo.addItem(N);
			cF.secCombo.setSelectedItem(N);
